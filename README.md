...
<!-- Capture the settings window or the hold overlay, save it as docs/screenshot.png,
     and uncomment the line below.
<img src="docs/screenshot.png" width="520" alt="HoldOn settings">
-->
...
The menu bar hand holds the switches: protection on and off, ⌘W guarding, settings, launch
at login.

Settings carries the hold time, from 0.3 s to 3.0 s, and where the guard applies:
